            ...
            <Layout>
                <div className='mx-auto py-16'>
                    <form>
                        ...
                        <input type='text' className='rounded-lg mb-1 py-2 px-2 w-64 shadow-sm outline-none focus:shadow-outline block' maxLength={100}/>
                        <label className='block mt-1 mb-1 text-gray-700 px-1 font-semibold'>Description</label>
                        <textarea className='w-64 h-20 rounded-lg py-2 px-2 shadow-sm outline-none focus:shadow-outline block' />
